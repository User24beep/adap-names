...
export class Link extends Node {
    ...
    public getTargetNode(): Node | null {
        IllegalArgumentException.assertCondition(this.targetNode !== null, "Target node is null");
        return this.targetNode;
    }

    public setTargetNode(target: Node): void {
        IllegalArgumentException.assertIsNotNullOrUndefined(target, "Target node cannot be null or undefined");
    ...
    protected ensureTargetNode(target: Node | null): Node {
        IllegalArgumentException.assertCondition(target !== null, "Target node is null");
